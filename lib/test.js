...
const SaTextEntities_1 = require("./SaTextEntities");
const saTextEntities = new SaTextEntities_1.SaTextEntities();
const text = `Want to get better at interviews from both sides of the table? 
